  ...
  return (
    <div className="p-4 text-2xl">
      ...
      <p className="text-[18px] my-2">
        A software that help you to handle your counseling in your organization,
        it provide many features of counseling like tracking status, interested,
      ...
      <div className={""}>
        <h2 className={"text-3xl font-bold py-4 text-center text-gray-600"}>
          Features
        </h2>
        {/*  features cards*/}
          ...
          <div className="bg-gray-200  rounded-md border-2 flex flex-col items-start gap-2 hover:scale-[1.01]">
            ...
            <div className="p-4">
              ...
              <p className="text-[18px] text-gray-700 pt-2">
                ...
                insights. Administrators and counselors can extract specific
                data for in-depth analysis, enabling personalized
                decision-making and a more targeted approach to addressing
                individual needs. This feature enhances the adaptability and
                effectiveness of the counseling system, catering to diverse
                requirements and ensuring a user-centric experience.
              </p>
            </div>
          </div>
          <div className="bg-gray-200  rounded-md border-2 flex flex-col items-start gap-2 hover:scale-[1.01]">
      ...
      <div id={"/#contact"} className={"m-auto "}>
        <h2 className={"text-3xl text-gray-600 pl-2 font-semibold my-4"}>
          Portfolio
        </h2>
        <embed
      ...
      <h2 className="text-3xl text-gray-600 font-semibold pl-2 mt-10">
        Contact
      </h2>
      <div className="my-4 lg:flex gap-2">
        {/* contact form */}
        <div className="min-w-[50%] min-h-fit border-2 p-4 m-2 rounded-md">
        ...
        <div className="border-2 p-4 m-2 rounded-md w-[100%] min-h-fit">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3507.0769755691917!2d78.75518557516622!3d23.831355078615204!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3978d1574891fdc7%3A0x679f6d33e76242d1!2sGopal%20Ganj%2C%20Sagar%2C%20Madhya%20Pradesh%20470001!5e1!3m2!1sen!2sin!4v1711823717864!5m2!1sen!2sin"
